          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                >
                  We help a patient live a healthy, longer life
                </h1>
                <p className='text_para'>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Possimus minima totam tenetur consequatur magnam nulla ex
                  impedit dolor laudantium eos quod consequuntur rem corrupti,
                  unde blanditiis.
                </p>
      ...
      <section>
        <div className="container">
          <div className=' lg:w-[470px] mx-auto'>
            <h2 className='heading text-center'>Provide the best medical services</h2>
            <p className='text_para text-center'>World class care for everyone. Our health sytem offers unmatched expert health care</p>
          </div>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World class care for everyone.
                  Our health Sytem offers unmatched, expert health care.
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className=" xl:w-[670px]">
              <h2 className="heading">Get Virtual Treatment <br /> any time.</h2>
              <ul className=' pl-4'>
                <li className="text_para">
                  1. Schedule the appointment directly
                </li>
                <li className="text_para">
                  2. Search for a physician and contact their office.
                </li>
                <li className="text_para">
                  3. View our physician who are accepting new patients, use online scheduling tool to select an appointment time.
                </li>
              </ul>
              <Link to="/">
              ...
              md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className=" flex items-center justify-between">
                  <div className=" flex items-center gap-[6px] lg:gap-3">
                    ...
                    <p className=' text-[10px] leading-[10px] lg:text-[14px] lg:leading-5
                    text-textColor font-[4S00]'>10:00Am</p>
                  </div>
