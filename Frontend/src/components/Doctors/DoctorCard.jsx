...
const DoctorCard = ({ doctor }) => {
    ...
    return (
        ...
        mt-3 lg:mt-5'>{name}</h2>
            ...
            px-2 lg:py-2 lg:px-6 text-[12px] leading-4 rounded lg:text-[16px] lg:leading-7 font-semibold'>{specialization}</span>

                <div className=" flex items-center gap-[6px]">
                    <span className=' flex items-center gap-[6px] leading-6 text-[14px] lg:text-[16px] 
                lg:leading-7 font-semibold text-headingColor'>
                        <img src={starIcon} alt="" />{avgRating}
                    </span>
                    <span className='leading-6 text-[14px] lg:text-[16px] lg:leading-7 font-[400] 
            ...
            <div className=" mt-[18px] lg:mt-5 flex items-center justify-between">
                <div>
                    <h3 className='text-[16px] leading-7 lg:text-[18px]
                       lg:leading-[30px] font-semibold text-headingColor'>+{totalPatients} patients
                    </h3>
